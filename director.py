...
class Director():
    ...
    def update_game(self):
        """
            Updates the game based on Player movement. If there
             is a collision, the game ends and the user is given
             the option to play again (keeping the previous scores).
        """
